...
def get_keyboard_inline1():
    ...
    but_inline1 = InlineKeyboardButton('послушать', url='https://genius.com/artists/Yabujin')
...
def get_keyboard_inline2():
    ...
    but_inline2 = InlineKeyboardButton('купить', url='https://www.farfetch.com/shopping/women/rick-owens-drkshdw-abstract-low-faux-fur-sneakers-item-19049566.aspx')
